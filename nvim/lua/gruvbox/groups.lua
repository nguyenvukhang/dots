...
M.setup = function()
  ...
  return {
    ...
    GruvboxRedUnderline = { sp = colors.red },
    GruvboxGreenUnderline = { sp = colors.green },
    GruvboxYellowUnderline = { sp = colors.yellow },
    GruvboxBlueUnderline = { sp = colors.blue },
    GruvboxPurpleUnderline = { sp = colors.purple },
